...
<div class="app-header">
    ...
    <div class="app-sub">
        ...
        <span style="color:#7c6af5; font-weight:600;">Búsqueda de línea con condiciones de Wolfe (1ª y 2ª) Y Optimizacion restringida por las condiciones de Karush-Kuhn-Tucker (KKT)</span>
    </div>
</div>
""", unsafe_allow_html=True)
...
<div class="card" style="padding:14px 20px;">
    ...
    <div class="card-sub">
        <span style="color:#74b9ff; font-weight:700;">●  Flecha azul (∇f)</span> — Gradiente de la función objetivo en x*. Apunta en la dirección de mayor crecimiento de f.<br>
        <span style="color:#f7b731; font-weight:700;">●  Flecha amarilla (λ∇g)</span> — Gradiente de la restricción de igualdad escalado por su multiplicador λ.<br>
        <span style="color:#00b894; font-weight:700;">●  Línea verde punteada</span> — Frontera de la restricción de desigualdad h(x,y) = 0. La región factible es donde h(x,y) ≤ 0.<br>
        <span style="color:#f7b731; font-weight:700;">●  Línea amarilla sólida</span> — Curva de la restricción de igualdad g(x,y) = 0.<br>
        <span style="color:#f85149; font-weight:700;">★  Estrella roja (x*)</span> — Punto óptimo encontrado.<br><br>
        <em>Condición de estacionariedad KKT: en x* se debe cumplir que <strong>∇f + Σλᵢ∇gᵢ + Σμⱼ∇hⱼ = 0</strong>, es decir, los vectores gradiente se cancelan entre sí.</em>
    </div>
</div>
""", unsafe_allow_html=True)
    except Exception as e:
